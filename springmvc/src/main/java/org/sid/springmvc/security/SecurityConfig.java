...
@Override
	...
	http.authorizeRequests().antMatchers("/user/**","/login/**","/webjars/**").permitAll(); // webjars pour utiliser bootstrap 
    http.authorizeRequests().anyRequest().authenticated();//toutes les requêtes nécessite l'authentification
